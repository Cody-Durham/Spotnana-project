...
<br>- In the new page toward the top right corner near the header you should see a button to ```Create new secrete key```. This will generate a new key to use in the .env file. (Number 2b) 
